package com.badese.common.config.db;
...
import com.badese.common.tool.SpringUtils;
...
public class DruidConfig
{
    ...
    @Bean
    @ConfigurationProperties("spring.datasource.druid.slave9")
    @ConditionalOnProperty(prefix = "spring.datasource.druid.slave9", name = "enabled", havingValue = "true")
    public DataSource slave9DataSource(DruidProperties druidProperties)
    {
        DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
        return druidProperties.dataSource(dataSource);
    }
    ...
    @Bean
    @ConfigurationProperties("spring.datasource.druid.slave10")
    @ConditionalOnProperty(prefix = "spring.datasource.druid.slave10", name = "enabled", havingValue = "true")
    public DataSource slave10DataSource(DruidProperties druidProperties)
    {
        DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
        return druidProperties.dataSource(dataSource);
    }
    ...
    public DynamicDataSource dataSource(DataSource masterDataSource)
    {
        ...
        setDataSource(targetDataSources, DataSourceType.SLAVE9.name(), "slave9DataSource");
        setDataSource(targetDataSources, DataSourceType.SLAVE10.name(), "slave10DataSource");
